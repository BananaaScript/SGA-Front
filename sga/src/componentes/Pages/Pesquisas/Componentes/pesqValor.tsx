...
export default function Tabela01(){
    ...
    const ativosFiltrados = ativos.filter(ativo =>
        ...
        ativo.valor.toLowerCase().includes(filtro.toLowerCase())
    );
    ...
    return(
        <>
                ...
                <div className="texto">
                    <h2>Monitoramento dos Ativos por Valor Monetário</h2>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th id="ClasseEspecialBusca">Valor</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr key={ativo.id}>
                                    ...
                                    <td id="ClasseEspecialBusca">{ativo.valor}</td>
                                </tr>
                                ))}
                            </tbody>
                        </table> <br /><br />
