...
export default function Tabela04(){
    ...
    const ativosFiltrados = ativos.filter(ativo =>
        ...
        ativo.cep.toLowerCase().includes(filtro.toLowerCase()) ||
        ativo.cidade.toLowerCase().includes(filtro.toLowerCase())
    );
    ...
    return(
        <>
                ...
                <div className="texto">
                    <h2>Monitoramento dos Ativos por Localização</h2>
                ...
                <div className="BoxTabela">
                            <input 
                                ...
                                placeholder="Filtrar por Nome, Cep ou Cidade..."
                            />
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th id="ClasseEspecialBusca">Cidade</th>
                                    <th id="ClasseEspecialBusca">CEP</th>
                            ...
                            <tbody>
                                ...
                                <tr key={ativo.id}>
                                    ...
                                    <td id="ClasseEspecialBusca">{ativo.cidade}</td>
                                    <td id="ClasseEspecialBusca">{ativo.cep}</td>
                                </tr>
                                ))}
                            </tbody>
                        </table> <br /><br />
