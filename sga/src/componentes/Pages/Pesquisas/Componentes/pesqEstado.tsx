...
export default function Tabela02(){
    ...
    const ativosFiltrados = ativos.filter(ativo =>
        ...
        ativo.estado.toLowerCase().includes(filtro.toLowerCase()) 
    );
    ...
    return(
        <>
                ...
                <div className="texto">
                    <h2>Monitoramento dos Ativos por Estado Fisíco</h2>
                        ...
                        <table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th id="ClasseEspecialBusca">Estado</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr key={ativo.id}>
                                    ...
                                    <td id="ClasseEspecialBusca">{ativo.estado}</td>
                                </tr>
